...
.progress-bar-unknown, .progress-bar-info {
    background-color: #079e10 !important;
}
...
<div class="row">
	...
	<?php
		...
		$unknown_percentage = number_format ((@$ChartSex->unknow_gender * 100) / @$TotalVoters ,2);
		...
		$voterMemberUnknown_percentage = number_format ((@$ChartSex->voterMemberUnknown * 100) / @$TotalVoters ,2);
	  ...
	  <div class="box box-default">
		...
		<div class="box-body">		  
		 ...
		 <div class="row Unknown">
				...
				<div class="col-lg-8">
					<div style="margin-top:25px;margin-left:5px;margin-right:10px">
						<div class="progress-unknown">
							<span class="progress-bar-female-voters" style="width:{{$voterMemberUnknown_percentage}}%;"></span>
							<div class="progress-bar progress-bar-unknown" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: {{$unknown_percentage}}%">
							  <span class="sr-only-text">{{$unknown_percentage}}%</span>
							</div>
						 </div>
